...
Download the latest release — it will be a file called something like `OpenCore-Patcher.pkg`. Always use the latest version. Do not use older versions you may have downloaded previously.

Open the `.pkg` and install once **OpenCore-Patcher.pkg** installed to your Applications folder.
